...
/*   Updated: 2024/06/18 10:24:41 by ballain          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_zoom_map(int keycode, t_map *map)
{
	...
	{
		map->modif.gap.x = map->cgravity.x - (map->col / 2) * map->modif.zoom;
		map->modif.gap.y = map->cgravity.y - (map->row / 2) * map->modif.zoom;
	}
}
